...
class _VideoPlayerScreenState extends State<VideoPlayerScreen> {
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset('assets/sf.mp4');
    listener = () {
      setState(() {});
    };
  ...
  void navigationPage() {
    ...
    Navigator.pushReplacement(context, BourcePageRoute(widget: LoginScreen()));
  }
                          ...
                          child: CircleAvatar(
                            child: CircleAvatar(
                                ...
                                backgroundImage: isLoading == true
                                    ? AssetImage("assets/icons/white.png")
                                    : AssetImage(
                                        "assets/icons/nextBlackIcon.png"),
                                child: InkWell(
                                        ...
                                        ? () async {
                                            ...
                                            if (userInit.userName != "") {
                                              userProvider.userLogin(
                                                  userInit, jwt);
                                              messageProvider
                                                  .userMessage(listMsgInit);
                                              userProvider
                                                  .userFriends(listFrInit);
                                              userProvider
                                                  .userHadChats(listHadChat);
                                              notifiProvider
                                                  .userNotifi(notifiInit);
                                              notifiProvider.timeSeen =
                                                  userInit.seenTimeNotifi;
                                              userProvider.listFrOfFrP =
                                                  listFrOfFr;
                                              userProvider.listConfirmFrP =
                                                  listConfirmFr;
                                              feedProvider
                                                  .userFeed(newListFeedOwnInit);
                                              feedProvider.userFrFeed(
                                                  newListFeedFrInit);
                                            }
                                            print(userProvider.userP.userName);
                                            print("realName");
                                            print(userProvider.userP.realName);
                                            if (userProvider.userP.realName ==
                                                "user") {
                                              Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
